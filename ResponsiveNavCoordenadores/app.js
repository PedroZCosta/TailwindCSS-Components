...
function onToggleMenu(e){
    ...
    if (e.name === 'menu') {
        ...
        Lists.classList.remove('top-[40px]', 'opacity-100');
        Lists.classList.add('top-[-40px]', 'opacity-0'); // Volta ao estado inicial
    } else {
        // Se estiver abrindo o menu
        Lists.classList.remove('top-[-40px]', 'opacity-0'); // Remove as classes de estado inicial
        Lists.classList.add('top-[40px]', 'opacity-100'); // Adiciona classes para abrir o menu
    }
}
